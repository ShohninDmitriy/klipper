...
//  {timer, pin,    channel, function}
    ...
    {TIM2,  GPIO('A',  5),  1, GPIO_FUNCTION(1)},    // EXP2_2       / EXP2_2       / EXP2_2          / EXP2_2       / Yes
//    {TIM2,  GPIO('A', 15),  1, GPIO_FUNCTION(1)},  // SPI3         / E3-CS        / -----           / E0-CS        / Yes
    {TIM2,  GPIO('B',  3),  2, GPIO_FUNCTION(1)},    // SPI3         / HE2          / -----           / HE0          / Yes
    {TIM2,  GPIO('B', 10),  3, GPIO_FUNCTION(1)},    // HE2          / EXP2_7       / -----           / EXP2_7       / Yes
    {TIM2,  GPIO('B',  2),  4, GPIO_FUNCTION(1)},    // EXP2_5       / FAN2         / EXP2_3          / FAN2         / Yes
    {TIM2,  GPIO('B', 11),  4, GPIO_FUNCTION(1)},    // HE3          / -----        / -----           / -----        / Yes
    {TIM3,  GPIO('B',  4),  1, GPIO_FUNCTION(2)},    // SPI3         / HB           / -----           / HE1          / Yes
    {TIM3,  GPIO('B',  5),  2, GPIO_FUNCTION(2)},    // SPI3         / LED-G fan4   / E0-Step         / -----        / Yes
    {TIM3,  GPIO('B',  0),  3, GPIO_FUNCTION(2)},    // RGB_LED      / FAN0         / EXP2_7          / FAN0         / Yes
    {TIM3,  GPIO('B',  1),  4, GPIO_FUNCTION(2)},    // EXP2_3       / FAN1         / EXP2_5          / FAN1         / Yes
    {TIM4,  GPIO('D', 12),  1, GPIO_FUNCTION(2)},    // FAN2         / E3-Step      / EXP3_14         / Z-CS         / Yes
    {TIM4,  GPIO('D', 13),  2, GPIO_FUNCTION(2)},    // FAN3         / Z-DIR        / Z-TX EXP3_13    / Z-DIR        / Yes
    {TIM5,  GPIO('A',  0),  1, GPIO_FUNCTION(2)},    // EN_DRIVER3   / Z-MIN        / X-Step          / Z-MIN        / Yes
    {TIM5,  GPIO('A',  1),  2, GPIO_FUNCTION(2)},    // HBED         / X-MAX        / HB              / X-MAX        / Yes
...
//    {TIM9,  GPIO('E',  6),  2, GPIO_FUNCTION(3)},  // Step_DRIVER7 / E1-Step      / Y-DIR           / E1-Step      / ?
    {TIM10, GPIO('B',  8),  1, GPIO_FUNCTION(3)},    // I2C_SCL      / I2C_SCL      / I2C_SCL EXP3_9  / I2C_SCL      / Yes
    {TIM11, GPIO('B',  9),  1, GPIO_FUNCTION(3)},    // I2C_SDA      / I2C_SDA      / I2C_SDA EXP3_10 / I2C_SDA      / Yes
//    {TIM12, GPIO('B', 14),  1, GPIO_FUNCTION(9)},  // USB          / X-MIN        / LED             / X-MIN        / ?
    {TIM12, GPIO('B', 15),  2, GPIO_FUNCTION(9)},    // USB          / HE0          / Y-MIN           / HE2          / ?
    {TIM13, GPIO('A',  6),  1, GPIO_FUNCTION(9)},    // EXP2_1       / EXP2_1       / EXP2_1          / EXP2_1       / Yes
    {TIM14, GPIO('A',  7),  1, GPIO_FUNCTION(9)}     // EXP2_6       / EXP2_6       / EXP2_6          / EXP2_6       / Yes
#endif
};
